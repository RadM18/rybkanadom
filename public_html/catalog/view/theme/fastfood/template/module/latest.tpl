<div class="box box_carousel">
  <div class="box-heading"><?php /*echo $heading_title; */?>Свежие поступления</div>
  <div class="box-content">
    <div class="box-product product_latest">
    <?php foreach ($products as $product) { ?>
    <div class="product product_<?php echo $product['product_id']; ?>_lm">
	...
	<?php if($product['weight_value'] > 0) { ?>
		<div class="weight weight_<?php echo $product['product_id']; ?>_lm" data-weight="<?php echo $product['weight_value']; ?>" data-weight-unit="<?php echo $product['weight_unit']; ?>"><?php echo $product['weight']; ?></div>
    <?php } ?>
	<?php if ($product['price']) { ?>
      <div class="price">
        <?php if (!$product['special']) { ?>
        <span class="price_<?php echo $product['product_id']; ?>_lm" data-price="<?php echo $product['price_value']; ?>"><?php echo $product['price']; ?></span>
        <?php } else { ?>
        <span class="price-old price_<?php echo $product['product_id']; ?>_lm" data-price="<?php echo $product['price_value']; ?>"><?php echo $product['price']; ?></span> 
		<span class="price-new special_<?php echo $product['product_id']; ?>_lm" data-price="<?php echo $product['special_value']; ?>"><?php echo $product['special']; ?></span>
        <?php } ?>
      </div>
    <?php } ?>
    <div class="cart">
    <?php if ($product['quantity'] > 0) { ?>
		<?php if ($show_quantity) { ?>
			<input type="tel" value="<?php echo $product['minimum']; ?>" onchange="recalculateprice('<?php echo $product['product_id']; ?>_lm', '<?php echo $product['minimum']; ?>');" class="quantity_<?php echo $product['product_id']; ?>_lm" />
		<?php } ?>
