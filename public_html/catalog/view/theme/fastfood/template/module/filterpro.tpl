<?php if ($filter_groups || $categories || $options || $manufacturers || $attributes || $price_slider) { ?>
    <div id="filterpro_box">
        <h3>Фильтр <div class="clear_filter"><i class="fa fa-times"> <?php echo $clear_filter?></i></div></h3>
        <form id="filterpro">
                ...
                <div class="collapsible">
                    <label>
                        <input type="checkbox" class="filtered" name="instock"
                               id="instock" <?php if ($instock_checked) echo 'checked="checked"'; ?>>
                        <span for="instock"><?php echo $text_instock ?></span></label>
                </div>
            </div>
            <div class="option_box" <?php if (!$price_slider) {
                ...
                <?php if ($display_filters == 'checkbox') { ?>
                    <?php foreach ($filter_groups as $filter_group) { ?>
                        <div class="option_box">
                            <div class="option_name <?php if (empty($expanded_filters)) {
                                echo "hided";
                            } ?>"><?php echo $filter_group['name']; ?></div>
                            <div class="collapsible" <?php if (empty($expanded_filters)) {
                                echo 'style="display:none"';
                            } ?>>
                                <ul>
                                        ...
                                        <li>
                                            <label>
                                                <input type="checkbox" class="filtered"
                                                       name="filter[<?php echo $filter_group['filter_group_id']; ?>][]"
                                                       value="<?php echo $filter['filter_id']; ?>"
                                                       id="filter<?php echo $filter['filter_id']; ?>"/>
                                                <span
                                                    for="filter<?php echo $filter['filter_id']; ?>"><?php echo $filter['name']; ?></span></label>
                                        </li>
                                    <?php } ?>
                                </ul>
                            </div>
                    ...
                    <?php foreach ($filter_groups as $filter_group) { ?>
                        <div class="option_box">
                            ...
                            <div class="collapsible" <?php if (empty($expanded_filters)) {
                                ...
                                <select id="filter_group_<?php echo $filter_group['filter_group_id']; ?>"
                                        name="filter[<?php echo $filter_group['filter_group_id']; ?>][]"
                                        class="filtered">
                                    <option value=""><?php echo $text_all ?></option>
                                    <?php foreach ($filter_group['filter'] as $filter) { ?>
                                        <option id="filter<?php echo $filter['filter_id']; ?>"
            ...
            <?php if ($categories) { ?>
                <div class="option_box">
                    <div class="option_name <?php if (empty($expanded_categories)) {
                        echo "hided";
                    } ?>"><?php echo $text_categories; ?></div>
                    <div class="collapsible" <?php if (empty($expanded_categories)) {
                        echo 'style="display:none"';
                    } ?>>
                                ...
                                <?php foreach ($categories as $category) { ?>
                                    <li>
                                        <label>
                                            ...
                                            <span
                                                for="cat_<?php echo $category['category_id']; ?>"><?php echo $category['name']; ?></span>
                                        </label>
                                    </li>
                                <?php } ?>
                            </ul>
            ...
            <?php if (isset($tags)) { ?>
                <div class="option_box">
                    <div class="option_name <?php if (empty($expanded_tags)) {
                        echo "hided";
                    } ?>"><?php echo $text_tags; ?></div>
                    <div class="collapsible" <?php if (empty($expanded_tags)) {
                        echo 'style="display:none"';
                    } ?>>
                        <ul id="filter_tags">
            ...
            <?php if ($manufacturers) { ?>
                <div class="option_box">
                    <div class="option_name <?php if (empty($expanded_manufacturer)) {
                        echo "hided";
                    } ?>"><?php echo $text_manufacturers; ?></div>
                    <div class="collapsible brand" <?php if (empty($expanded_manufacturer)) {
                        echo 'style="display:none"';
                    } ?>>
                                    ...
                                    <li>
                                        <label>
                                            <input id="manufacturer_<?php echo $manufacturer['manufacturer_id'] ?>"
                                                   ...
                                                   value="<?php echo $manufacturer['manufacturer_id'] ?>"><span
                                                for="manufacturer_<?php echo $manufacturer['manufacturer_id'] ?>"><?php echo $manufacturer['name'] ?></span></label>
                                    </li>
                                <?php } ?>
                            </ul>
                                ...
                                <?php foreach ($manufacturers as $manufacturer) { ?>
                                    <li>
                                        <label>
                                            ...
                                            <span
                                                for="manufacturer_<?php echo $manufacturer['manufacturer_id'] ?>"><?php echo $manufacturer['name'] ?></span>
                                        </label>
                                    </li>
                                <?php } ?>
                            </ul>
                        <?php } elseif ($display_manufacturer == 'image') { ?>
                            <?php foreach ($manufacturers as $manufacturer) { ?>
                                <input style="display: none;" class="filtered manufacturer_value"
                                       id="manufacturer_<?php echo $manufacturer['manufacturer_id'] ?>"
                                       type="checkbox" name="manufacturer[]"
                                       value="<?php echo $manufacturer['manufacturer_id'] ?>">
                                <img data-toggle="tooltip" src="<?php echo $manufacturer['image'] ?>"
                                     title=" "
                                     alt=" "/>
                            <?php } ?>
                        <?php } ?>
                ...
                <?php foreach ($attributes as $attribute_group_id => $attribute) { ?>
                    ...
                    <?php foreach ($attribute['attribute_values'] as $attribute_value_id => $attribute_value) { ?>
                        <div class="attribute_box <?php if ($attr_group == "0") echo "option_box"; ?>">
                            <div class="option_name <?php if (!$attribute_value['expanded']) {
                                echo "hided";
                            } ?>"><?php echo $attribute_value['name']; ?></div>
                            <div class="collapsible" <?php if (!$attribute_value['expanded']) {
                                echo 'style="display:none"';
                            } ?>>
          ...
          <?php } ?>
            ...
            <?php if ($options) { ?>
                <?php foreach ($options as $option) { ?>
                    <div class="option_box">
                        <div class="option_name <?php if (!$option['expanded']) {
                            echo "hided";
                        } ?>"><?php echo $option['name']; ?></div>
                        <?php if ($option['display'] == 'select') { ?>
                            <div class="collapsible" <?php if (!$option['expanded']) {
                                echo 'style="display:none"';
                            } ?>>
                        ...
                        <?php } elseif ($option['display'] == 'checkbox') { ?>
                            <ul class="collapsible" <?php if (!$option['expanded']) {
                                echo 'style="display:none"';
                            } ?>>
                                <?php foreach ($option['option_values'] as $option_value) { ?>
                                    <li>
                                        <label>
                                            ...
                                            <span
                                                for="option_value_<?php echo $option_value['option_value_id'] ?>"><?php echo $option_value['name'] ?></span>
                                        </label>
                                    </li>
                                <?php } ?>
                            </ul>
                        ...
                        <?php } elseif ($option['display'] == 'image') { ?>
                            <div class="collapsible" <?php if (!$option['expanded']) {
                                ...
                                <?php foreach ($option['option_values'] as $option_value) { ?>
                                    <input style="display: none;" class="filtered option_value"
                                           id="option_value_<?php echo $option_value['option_value_id'] ?>"
                                           type="checkbox" name="option_value[<?php echo $option['option_id'] ?>][]"
                                           value="<?php echo $option_value['option_value_id'] ?>">
                                    <img data-toggle="tooltip" src="<?php echo $option_value['thumb']; ?>"
                                         title=" "
                                         alt=" "/>
                                <?php } ?>
                            </div>
