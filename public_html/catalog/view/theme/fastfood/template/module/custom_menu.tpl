...
<li class="arrow"><a href="<?php echo $menu['link'] ?>"><?php if($menu['image']) { ?><img src="<?php echo $menu['image']; ?>" alt=" " /><?php } else { ?><i class="fa fa-chevron-right"></i><?php } ?><?php echo $menu['name']; ?></a><i class="fa fa-chevron-down"></i>
<?php } else {?>
<li><a href="<?php echo $menu['link'] ?>"><?php if($menu['image']) { ?><img src="<?php echo $menu['image']; ?>" alt=" " /><?php } else { ?><i class="fa fa-chevron-right"></i><?php } ?><?php echo $menu['name']; ?></a>
<?php }?>		
<?php if($menu['sub_menu']){ ?>
...
<a class="first_child" href="<?php echo $menu['sub_menu'][$i]['link']; ?>"><?php if($menu['sub_menu'][$i]['image']) { ?><img src="<?php echo $menu['sub_menu'][$i]['image']; ?>" alt=" " /><?php } ?> <?php echo $menu['sub_menu'][$i]['name']; ?></a>
<?php } else {?>
<b class="first_child"><?php if($menu['sub_menu'][$i]['image']) { ?><img src="<?php echo $menu['sub_menu'][$i]['image']; ?>" alt=" " /><?php } ?> <?php echo $menu['sub_menu'][$i]['name']; ?></b>
<?php } ?>
