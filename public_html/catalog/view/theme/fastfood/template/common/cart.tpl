...
<div id="cart_content">
    ...
    <div class="mini-cart-info">
      <table>
        ...
        <tr>
			<td class="image"><?php if ($product['thumb']) { ?><a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" alt=" " title=" " /></a><?php } ?></td>
        ...
        <tr>
          ...
          <td class="remove"><img src="catalog/view/theme/default/image/remove-small.png" alt=" " title=" " onclick="(getURLVar('route') == 'checkout/cart' || getURLVar('route') == 'checkout/checkout') ? location = 'index.php?route=checkout/cart&remove=<?php echo $voucher['key']; ?>' : $('#cart_content').load('index.php?route=common/cart&remove=<?php echo $voucher['key']; ?>' + ' #cart > *');" /></td>
        </tr>
        <?php } ?>
      </table>
    </div>
	...
	<?php } ?>
		...
		<div class="pol">Оплату товара можно произвести курьеру картой или наличными.</div>
		<div class="pol">Отправляя заявку, вы выражаете свое согласие на обработку персональных данных. </br><a href="/privacy" target="_blank">Политика конфиденциальности</a></div>
	</div>
	<?php } ?>
...
<div class="shipping-table">
    ...
    <div class="shipping-table-inner">
        <table>
            <tr>
                <th>Район</th>
                <th>Цена, от</th>
