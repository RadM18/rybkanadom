...
<script>
  ...
  <?php } elseif (isset($news_data)) { ?>
    ...
    <?php foreach ($news_data as $news) { ?>
			<div class="image_description row col-xs-12 col-sm-3 col-md-4">
			<div class="  col-xs-12 col-sm-12 col-md-12"><img src="<?php echo $news['image']; ?>" alt="<?php echo $news['title']; ?>" class="img-responsive" /></div>
			 
			<div class="col-xs-12 col-sm-12 col-md-12">
				<h4 style="height:40px;"><?php echo $news['title']; ?></h4>
