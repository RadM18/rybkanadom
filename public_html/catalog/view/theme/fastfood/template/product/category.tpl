...
<div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
  ...
  <div class="category_heading" style="background: rgba(0, 0, 0, .1) <?php if($thumb) { ?>url('<?php echo HTTPS_SERVER; ?>image/<?php echo $thumb; ?>')no-repeat;<?php } ?>"><h1><?php echo $heading_title; ?></h1></div><?php if (!isset($_GET['page'])) { ?>
	<script>
  ...
  <div class="category-list">
    <ul>
	  ...
	  <?php if(isset($category['thumb'])) { ?><img src="<?php echo $category['thumb']; ?>" alt=" "><?php } ?>
