...
<div id="content" class="<?php echo $class; ?>">
	...
	<div class="product-info product_<?php echo $product_id; ?>">
		<?php if ($thumb || $images) { ?>
		<div class="left">
			<?php if ($bestseller_sticker) { ?>
			<div class="sticker st_bestseller"><?php echo $bestseller_sticker_text; ?></div>
			<?php } ?>
			<?php if ($new_sticker) { ?>
			<div class="sticker st_new"><?php echo $new_sticker_text; ?></div>
			<?php } ?>
			<?php if ($special_sticker) { ?>
			<div class="sticker st_special"><?php echo $special_sticker; ?></div>
			<?php } ?>
			<?php if ($thumb) { ?>
			<div class="image"><a href="<?php echo $popup; ?>" title=" "><img src="<?php echo $popup; ?>" title=" " alt=" " id="image" /></a></div>
			<?php } ?>
			<?php if ($images) { ?>
			<div class="image-additional">
				<!--  <img src="<?php echo $small; ?>" data-thumb="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /> -->
				<?php foreach ($images as $image) { ?>
				<a href="<?php echo $image['popup']; ?>" title=" "><img src="<?php echo $image['thumb']; ?>" data-popup="<?php echo $image['popup']; ?>" data-thumb="<?php echo $image['small']; ?>" title=" " alt=" " /></a>
				<?php } ?>
			</div>
			<?php } ?>
		</div>
		...
		<div class="right">
			...
			<div>
				<div class="description">
					...
					<?php if ($weight) { ?>
					<div><span><?php echo $text_weight; ?></span><span class="weight_<?php echo $product_id; ?>" data-weight="<?php echo $weight_value; ?>" data-weight-unit="<?php echo $weight_unit; ?>"><?php echo $weight; ?></span></div>
					<?php } ?>
				</div>
				<?php if ($options) { ?>
				<div class="options">
					...
					<div id="input-option<?php echo $option['product_option_id']; ?>" class="option form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
						...
						<select name="option[<?php echo $option['product_option_id']; ?>]">
							<option value="" data-points="0" data-weight="0"><?php echo $text_select; ?></option>
					...
					<div id="input-option<?php echo $option['product_option_id']; ?>" class="option form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
						...
						<div class="option-image">
							...
							<div>
								...
								<?php if ($option_value['price']) { ?><br /><span>
          <?php
          if ($option_value['price_prefix'] == '*') {
            if ($option_value['price_value'] != 1.0)
              printf("(%+d%%)", round(($option_value['price_value'] * 100) - 100) );
		...
		<div class="box-content">
			<div class="box-product product_related">
				...
				<div class="product product_<?php echo $product['product_id']; ?>_rm">
					...
					<div class="image">
						<a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" data-id="<?php echo $product['product_id']; ?>" class="image<?php echo $product['product_id']; ?> img-responsive" title=" " alt=" " /></a>
          ...
          ?>
						...
						<div class="compare"><a onclick="addToCompare('<?php echo $product['product_id']; ?>');" title=" "><i class="fa fa-bar-chart-o"></i></a></div>
					</div>
				</div>
				<?php } ?>
			</div>
